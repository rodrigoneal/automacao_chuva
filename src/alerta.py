...
bairros = ['Irajá', 'Madureira', 'Bangu', 'Campo Grande', 'Av. Brasil/Mendanha','Santa Cruz']
...
def pegar_clima() -> List[Elemento]:
    ...
    tables_rows = driver.find_element(By.XPATH, '/html/body/table[1]').find_elements(By.TAG_NAME, 'tr')
    elementos = []
